...
import { formatShortcutKey, getPlatform, groupShortcutsByCategory, type KeyboardShortcut } from '@/hooks/use-keyboard-shortcuts';
import {
                ...
                <CommandList>
                    ...
                    {sortedCategories.map((category, categoryIndex) => (
                        <React.Fragment key={category}>
                            ...
                            {categoryIndex < sortedCategories.length - 1 && <CommandSeparator />}
                        </React.Fragment>
                    ))}
                </CommandList>
            </CommandDialog>
