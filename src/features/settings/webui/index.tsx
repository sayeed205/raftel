...
import { GlobeIcon, LockIcon, MonitorIcon, ShieldIcon } from 'lucide-react';
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    setPendingChange('use_https', checked)
                  }
                />
                  ...
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        value={
                          (getValue('web_ui_https_cert_path') as string) || ''
                        }
                        onChange={(e) =>
                          setPendingChange(
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        value={
                          (getValue('web_ui_https_key_path') as string) || ''
                        }
                        onChange={(e) =>
                          setPendingChange(
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  setPendingChange('bypass_local_auth', checked)
                }
              />
              ...
              {(getValue(
                ...
                <div className="ml-6 space-y-2">
                  <Input
                    ...
                    value={
                      (getValue('bypass_auth_subnet_whitelist') as string) || ''
                    }
                    onChange={(e) =>
                      setPendingChange(
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2">
                  <Input
                    ...
                    min="1"
                    value={
                      (getValue('web_ui_session_timeout') as number) || 3600
                    }
                    onChange={(e) =>
                      setPendingChange(
          ...
          <CardContent className="space-y-4">
              ...
              {(getValue(
                ...
                <div className="ml-6 space-y-2">
                  ...
                  <textarea
                    ...
                    value={
                      (getValue('web_ui_custom_http_headers') as string) || ''
                    }
                    onChange={(e) =>
                      setPendingChange(
            ...
            <div className="space-y-2">
              ...
              {(getValue('web_ui_reverse_proxy_enabled') as boolean) && (
                <div className="ml-6 space-y-2">
                  <div className="space-y-2">
                    <Label htmlFor="web_ui_reverse_proxies_list">
                      Trusted proxies list
                    </Label>
                    <Input
                      id="web_ui_reverse_proxies_list"
                      value={
                        (getValue('web_ui_reverse_proxies_list') as string) ||
                        ''
                      }
                      onChange={(e) =>
                        setPendingChange(
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    setPendingChange('dyndns_enabled', checked)
                  }
                />
                <Label htmlFor="dyndns_enabled">
                  Use this server for dynamic DNS
                </Label>
              </div>
            </div>
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        setPendingChange('dyndns_service', value)
                      }
                    >
                      <SelectTrigger>
                        <SelectValue />
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setPendingChange('dyndns_domain', e.target.value)
                      }
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setPendingChange('dyndns_username', e.target.value)
                      }
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setPendingChange('dyndns_password', e.target.value)
                      }
                    />
                  </div>
                </div>
