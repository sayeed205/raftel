...
export default function SettingsDownloads() {
  ...
  return (
    <ContentSection title='Downloads' desc='Update your download settings and behavior.'>
            ...
            <div className='space-y-4'>
              ...
              <div className='flex items-center space-x-2'>
                ...
                <Label htmlFor='preallocate_all'>
                  ...
                  <p className='text-muted-foreground text-sm font-light'>
                    Allocate full file size on disk immediately. Prevents fragmentation but uses
                    more disk space.
                  </p>
                </Label>
              </div>
