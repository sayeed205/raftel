    ...
    <div className='space-y-6'>
      {showAdvancedWarning && (
        <Alert>
          ...
          <AlertDescription>
            For better organization, consider enabling "Show advanced settings"
            in the Interface Customization section of Web UI Settings.
          </AlertDescription>
        </Alert>
      )}
          ...
          <div className='grid grid-cols-1 gap-4 md:grid-cols-2'>
            <div className='space-y-2'>
              ...
              <Input
                ...
                onChange={(e) =>
                  setPendingChange('disk_cache', parseInt(e.target.value))
                }
              />
            ...
            <div className='space-y-2'>
              ...
              <Input
                ...
                onChange={(e) =>
                  setPendingChange('disk_cache_ttl', parseInt(e.target.value))
                }
              />
              <p className='text-muted-foreground text-sm'>
          ...
          <div className='space-y-4'>
            <div className='space-y-2'>
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setPendingChange('disk_io_mode', parseInt(value))
                }
              >
                <SelectTrigger>
                  <SelectValue />
            ...
            <div className='space-y-4'>
              <div className='flex items-center space-x-2'>
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    setPendingChange('enable_os_cache', checked)
                  }
                />
              ...
              <div className='flex items-center space-x-2'>
                <Checkbox
                  ...
                  checked={
                    (getValue('enable_coalesce_read_write') as boolean) || false
                  }
                  onCheckedChange={(checked) =>
                    setPendingChange('enable_coalesce_read_write', checked)
                  }
                />
                <Label htmlFor='enable_coalesce_read_write'>
              ...
              <div className='flex items-center space-x-2'>
                ...
                />
                <Label htmlFor='enable_piece_extent_affinity'>
      ...
      <Card>
        ...
        <CardContent className='space-y-4'>
          <div className='grid grid-cols-1 gap-4 md:grid-cols-2'>
            ...
            <div className='space-y-2'>
              <Label htmlFor='send_buffer_low_watermark'>
                Send buffer low watermark (bytes)
              </Label>
              <Input
                ...
                min='1'
                value={
                  (getValue('send_buffer_low_watermark') as number) || 10000
                }
                onChange={(e) =>
                  setPendingChange(
          ...
          <p className='text-muted-foreground text-sm'>
            Set both to 0 to use any available port. Useful for restrictive
            firewalls.
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className='space-y-4'>
          <div className='space-y-2'>
            ...
            <Select
              value={
                (getValue('resume_data_storage_type') as number)?.toString() ||
                '0'
              }
              onValueChange={(value) =>
        ...
        <CardContent className='space-y-4'>
          <div className='flex items-center space-x-2'>
            <Checkbox
              ...
              onCheckedChange={(checked) =>
                setPendingChange('queueing_enabled', checked)
              }
            />
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Configure the built-in BitTorrent tracker.
          </CardDescription>
        </CardHeader>
        <CardContent className='space-y-4'>
          <div className='flex items-center space-x-2'>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Run external programs when torrents complete.
          </CardDescription>
        </CardHeader>
        <CardContent className='space-y-4'>
          <div className='flex items-center space-x-2'>
            <Checkbox
              ...
              onCheckedChange={(checked) =>
                setPendingChange('autorun_enabled', checked)
              }
            />
            <Label htmlFor='autorun_enabled'>
          ...
          {(getValue('autorun_enabled') as boolean) && (
            <div className='ml-6 space-y-2'>
              ...
              <Textarea
                ...
                onChange={(e) =>
                  setPendingChange('autorun_program', e.target.value)
                }
                placeholder='/path/to/program "%N" "%L" "%F" "%R" "%D" "%C" "%Z" "%T" "%I"'
                rows={3}
              />
              <p className='text-muted-foreground text-sm'>
                Supported parameters: %N (name), %L (label), %F (content path),
                %R (root path), %D (save path), %C (number of files), %Z
                (torrent size), %T (current tracker), %I (info hash)
              </p>
            </div>
          )}
        </CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Send email notifications when torrents complete.
          </CardDescription>
        </CardHeader>
        <CardContent className='space-y-4'>
          <div className='flex items-center space-x-2'>
            <Checkbox
              ...
              checked={
                (getValue('mail_notification_enabled') as boolean) || false
              }
              onCheckedChange={(checked) =>
                setPendingChange('mail_notification_enabled', checked)
              }
            />
            <Label htmlFor='mail_notification_enabled'>
              ...
              <div className='grid grid-cols-1 gap-4 md:grid-cols-2'>
                <div className='space-y-2'>
                  ...
                  <Input
                    ...
                    type='email'
                    value={
                      (getValue('mail_notification_sender') as string) || ''
                    }
                    onChange={(e) =>
                      setPendingChange(
                ...
                <div className='space-y-2'>
                  ...
                  <Input
                    ...
                    type='email'
                    value={
                      (getValue('mail_notification_email') as string) || ''
                    }
                    onChange={(e) =>
                      setPendingChange(
                ...
                <div className='space-y-2'>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setPendingChange('mail_notification_smtp', e.target.value)
                    }
              ...
              <div className='space-y-4'>
                <div className='flex items-center space-x-2'>
                  <Checkbox
                    ...
                    checked={
                      (getValue('mail_notification_ssl_enabled') as boolean) ||
                      false
                    }
                    onCheckedChange={(checked) =>
                ...
                <div className='flex items-center space-x-2'>
                  ...
                  />
                  <Label htmlFor='mail_notification_auth_enabled'>
                    Use authentication
                  </Label>
                </div>
                  ...
                  <div className='ml-6 grid grid-cols-1 gap-4 md:grid-cols-2'>
                    <div className='space-y-2'>
                      ...
                      <Input
                        ...
                        value={
                          (getValue('mail_notification_username') as string) ||
                          ''
                        }
                        onChange={(e) =>
                          setPendingChange(
                    ...
                    <div className='space-y-2'>
                      ...
                      <Input
                        ...
                        type='password'
                        value={
                          (getValue('mail_notification_password') as string) ||
                          ''
                        }
                        onChange={(e) =>
                          setPendingChange(
          ...
          <div className='space-y-4'>
            <div className='flex items-center space-x-2'>
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  setPendingChange('check_for_updates', checked)
                }
              />
              <Label htmlFor='check_for_updates'>
            ...
            <div className='flex items-center space-x-2'>
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  setPendingChange('use_icon_theme', checked)
                }
              />
            ...
            <div className='flex items-center space-x-2'>
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  setPendingChange('performance_warning', checked)
                }
              />
              <Label htmlFor='performance_warning'>
            ...
            <div className='flex items-center space-x-2'>
              <Checkbox
                ...
                checked={
                  (getValue('confirm_torrent_deletion') as boolean) || false
                }
                onCheckedChange={(checked) =>
                  setPendingChange('confirm_torrent_deletion', checked)
                }
              />
              <Label htmlFor='confirm_torrent_deletion'>
            ...
            <div className='flex items-center space-x-2'>
              <Checkbox
                ...
                checked={
                  (getValue('confirm_torrent_recheck') as boolean) || false
                }
                onCheckedChange={(checked) =>
                  setPendingChange('confirm_torrent_recheck', checked)
                }
              />
              <Label htmlFor='confirm_torrent_recheck'>
