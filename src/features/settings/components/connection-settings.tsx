            ...
            <div className='space-y-2'>
              ...
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value='2'>SOCKS4</SelectItem>
                  <SelectItem value='3'>SOCKS5</SelectItem>
                </SelectContent>
              </Select>
            </div>
                ...
                <div className='grid grid-cols-1 gap-4 md:grid-cols-2'>
                  ...
                  <div className='space-y-2'>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setPendingChange('proxy_port', parseInt(e.target.value))
                      }
                    />
                  </div>
                ...
                <div className='space-y-4'>
                  ...
                  <div className='flex items-center space-x-2'>
                    <Checkbox
                      ...
                      checked={
                        (getValue('proxy_peer_connections') as boolean) || false
                      }
                      onCheckedChange={(checked) =>
                  ...
                  <div className='flex items-center space-x-2'>
                    <Checkbox
                      ...
                      checked={
                        (getValue('proxy_hostname_lookup') as boolean) || false
                      }
                      onCheckedChange={(checked) =>
