        ...
        <>
            ...
            <Main>
                <div className={layout.spacing.section}>
                    {/* Page Header */}
                    <section
                        className={`flex ${layout.isMobile
                            ? 'flex-col gap-3'
                    ...
                    >
                        ...
                        <div className={`flex ${layout.spacing.button}`}>
                            ...
                            >
                                <Plus
                                    className={`${layout.iconSize} ${layout.isMobile ? '' : 'md:mr-2'
                                        }`}
                                />
                            ...
                            {[
                                ...
                                return (
                                    <Button
                                        ...
                                        className={`touch-manipulation rounded-full whitespace-nowrap transition-all ${layout.isMobile
                                    ...
                                    >
                                        {label}
                                        <Badge
                                            className={` ${layout.isMobile ? 'ml-2 px-2 py-0.5 text-xs' : 'ml-1.5'
                                                } ${selectedFilter === key
