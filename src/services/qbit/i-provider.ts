...
import type { Log, PeerLog } from '@/types/logs';
import type {
  AddTorrentPayload,
...
export default interface IProvider {
   ...
   */
  getNetworkInterfaces: () => Promise<Array<NetworkInterface>>;

  /**
   * Get the network addresses
   * @param iface Network interface name
   */
  getAddresses: (iface: string) => Promise<Array<string>>;
   ...
   * @throws 404 if directory doesn't exist
   */
  getDirectoryContent: (
    dirPath: string,
   ...
   * @param cookies
   */
  setCookies: (cookies: Array<Cookie>) => Promise<void>;
   ...
   */
  getLogs: (afterId?: number, logsToInclude?: LogType) => Promise<Array<Log>>;

  /**
   * Get Peer logs
   * @param afterId Log ID to start from , defaults to all
   */
  getPeerLogs: (afterId?: number) => Promise<Array<PeerLog>>;
   ...
   */
  getFeeds: (withData: boolean) => Promise<Array<Feed>>;

  /**
   * Get the RSS feed rules
   */
  getRules: () => Promise<Array<FeedRule>>;
   ...
   * @param id Search job ID
   */
  getSearchStatus: (id?: number) => Promise<Array<SearchStatus>>;
   ...
   */
  getSearchPlugins: () => Promise<Array<SearchPlugin>>;

  /**
   * Install a search plugin
   * @param sources Plugin sources
   */
  installSearchPlugin: (sources: Array<string>) => Promise<boolean>;

  /**
   * Uninstall a search plugin
   * @param names Plugin names
   */
  uninstallSearchPlugin: (names: Array<string>) => Promise<void>;
   ...
   */
  enableSearchPlugin: (names: Array<string>, enable: boolean) => Promise<void>;
   ...
   */
  getTorrents: (payload?: GetTorrentPayload) => Promise<Array<Torrent>>;

  /**
   * Get the torrent trackers
   * @param hash Torrent hash
   */
  getTorrentTrackers: (hash: string) => Promise<Array<TorrentTracker>>;
   ...
   * @param hash Torrent hash
   */
  getTorrentPieceStates: (hash: string) => Promise<Array<PieceState>>;
   ...
   * Get all the tags
   */
  getAvailableTags: () => Promise<Array<string>>;
   ...
   * @param hashes Torrent hashes
   */
  stopTorrents: (hashes: Array<string>) => Promise<void>;
   ...
   * @param hashes Torrent hashes
   */
  startTorrents: (hashes: Array<string>) => Promise<void>;

  /**
   * Force start torrents
   * @param hashes Torrent hashes
   */
  forceStartTorrents: (hashes: Array<string>) => Promise<void>;

  /**
   * Toggle sequential download flag
   * @param hashes Torrent hashes
   */
  toggleSequentialDownload: (hashes: Array<string>) => Promise<void>;

  /**
   * Toggle first/last piece priority flag
   * @param hashes Torrent hashes
   */
  toggleFirstLastPiecePriority: (hashes: Array<string>) => Promise<void>;
   ...
   */
  setSuperSeeding: (hashes: Array<string>, value: boolean) => Promise<void>;
   ...
   */
  setAutoTMM: (hashes: Array<string>, enable: boolean) => Promise<void>;
   ...
   */
  setDownloadLimit: (hashes: Array<string>, limit: number) => Promise<void>;
   ...
   */
  setUploadLimit: (hashes: Array<string>, limit: number) => Promise<void>;
   ...
   */
  setTorrentSavePath: (hashes: Array<string>, path: string) => Promise<void>;
   ...
   */
  addTorrentTag: (hashes: Array<string>, tags: Array<string>) => Promise<void>;
   ...
   */
  createTag: (tags: Array<string>) => Promise<void>;

  /**
   * Delete a tag
   * @param tags Tags to delete
   */
  deleteTags: (tags: Array<string>) => Promise<void>;
   ...
   */
  deleteCategory: (categories: Array<string>) => Promise<void>;
   ...
   */
  setCategory: (hashes: Array<string>, category: string) => Promise<void>;
   ...
   */
  banPeers: (peers: Array<string>) => Promise<void>;
}
