...
export default class MockProvider implements IProvider {
  ...
  async getMainData(rid?: number): Promise<MainDataResponse> {
    ...
    const server_state = {
      ...
      dl_info_speed: faker.number.int({
        min: 0,
        // eslint-disable-next-line @typescript-eslint/no-unnecessary-condition
        max: dl_rate_limit || 125_000_000,
      }), // [0 b/s; 1 Gb/s]
      dl_rate_limit,
      ...
      up_info_speed: faker.number.int({
        min: 0,
        // eslint-disable-next-line @typescript-eslint/no-unnecessary-condition
        max: up_rate_limit || 125_000_000,
      }), // [0 b/s; 1 Gb/s]
      up_rate_limit,
  ...
  async getAddresses(iface: string = ''): Promise<Array<string>> {
    switch (iface) {
      case 'lo':
        return this.generateResponse({
          result: ['127.0.0.1'],
  ...
  setCookies(_: Array<Cookie>): Promise<void> {
    return this.generateResponse();
  }
  ...
  async getLogs(_0?: number, _1?: LogType): Promise<Array<Log>> {
    ...
    return this.generateResponse({
      result: [
        ...
        },
        {
          id: 2,
          message:
            'Trying to listen on the following list of IP addresses: "0.0.0.0:6881,[::]:6881"',
          timestamp,
        ...
        },
        {
          id: 14,
          message:
            'IP geolocation database loaded. Type: DBIP-Country-Lite. Build time: Fri Dec 1 01:11:53 2023.',
          timestamp,
          type: LogType.INFO,
        },
        {
  ...
  async getPeerLogs(_?: number): Promise<Array<PeerLog>> {
    const timestamp = Math.floor(new Date().getTime() / 1000);
    return this.generateResponse({
      result: [
        {
  ...
  async getFeeds(_: boolean): Promise<Array<Feed>> {
    return this.generateResponse({
      result: [
        {
          hasError: false,
          ...
          articles: [
            {
              ...
              title:
                'Lorem ipsum odor amet, consectetuer adipiscing elit. Tristique maximus pellentesque lacinia, interdum suspendisse feugiat senectus consectetur porta.',
  ...
  async getSearchPlugins(): Promise<Array<SearchPlugin>> {
    return this.generateResponse({
      ...
      ] as Array<SearchPlugin>,
    });
  }

  async installSearchPlugin(_: Array<string>): Promise<boolean> {
    return this.generateResponse({ result: true });
  }

  async uninstallSearchPlugin(_: Array<string>): Promise<void> {
    return this.generateResponse();
  }

  async enableSearchPlugin(_0: Array<string>, _1: boolean): Promise<void> {
    return this.generateResponse();
  }
      ...
      result: {
        ...
        peers: {
          [`${ip1}:${port1}`]: {
            ...
            connection: randomConnType(),
            country: randomCountry(),
            country_code: randomCountryCode(),
            dl_speed: randomSpeed(),
            downloaded: randomData(),
  ...
  async getTorrentCreatorOutput(_: string): Promise<Blob> {
    return this.generateResponse({
      result: new Blob([new ArrayBuffer(1024)], {
  ...
  async getTorrents(_?: GetTorrentPayload): Promise<Array<Torrent>> {
    return this.generateResponse({
      result: MockProvider.hashes.map((hash) => ({
        ...this.generateMockedTorrent(hash),
        hash,
      })),
    });
  }

  async getTorrentTrackers(_: string): Promise<Array<TorrentTracker>> {
    ...
    return this.generateResponse({
      result: [
        {
          msg: '',
          num_downloaded: getRandomValue(),
          num_leeches: getRandomValue(),
          num_peers: getRandomValue(),
          num_seeds: getRandomValue(),
          status: 2,
          tier: -1,
          url: '** [DHT] **',
        },
  ...
  async getTorrentPieceStates(_: string): Promise<Array<PieceStateType>> {
    return this.generateResponse({
      result: new Array(64).fill(PieceState.MISSING),
    });
  }
  ...
  async deleteTorrents(_0: Array<string>, _1: boolean): Promise<void> {
    return this.generateResponse();
  }

  async pauseTorrents(_: Array<string>): Promise<void> {
    return this.generateResponse();
  }

  async stopTorrents(_: Array<string>): Promise<void> {
    return this.generateResponse();
  }

  async resumeTorrents(_: Array<string>): Promise<void> {
    return this.generateResponse();
  }

  async startTorrents(_: Array<string>): Promise<void> {
    return this.generateResponse();
  }

  async forceStartTorrents(_: Array<string>): Promise<void> {
    return this.generateResponse();
  }

  async toggleSequentialDownload(_: Array<string>): Promise<void> {
    return this.generateResponse();
  }

  async toggleFirstLastPiecePriority(_: Array<string>): Promise<void> {
    return this.generateResponse();
  }

  async setSuperSeeding(_0: Array<string>, _1: boolean): Promise<void> {
    return this.generateResponse();
  }

  async setAutoTMM(_0: Array<string>, _1: boolean): Promise<void> {
    return this.generateResponse();
  }

  async setDownloadLimit(_0: Array<string>, _1: number): Promise<void> {
    return this.generateResponse();
  }

  async setUploadLimit(_0: Array<string>, _1: number): Promise<void> {
    return this.generateResponse();
  }
  ...
  async reannounceTorrents(_: Array<string>): Promise<void> {
    return this.generateResponse();
  }

  async recheckTorrents(_: Array<string>): Promise<void> {
    return this.generateResponse();
  }

  async setTorrentDownloadPath(_0: Array<string>, _1: string): Promise<void> {
    return this.generateResponse();
  }

  async setTorrentSavePath(_0: Array<string>, _1: string): Promise<void> {
    return this.generateResponse();
  }
  ...
  async removeTorrentTrackers(_0: string, _1: Array<string>): Promise<void> {
    return this.generateResponse();
  }

  async addTorrentPeers(_0: Array<string>, _1: Array<string>): Promise<void> {
    return this.generateResponse();
  }
  ...
  async setTorrentPriority(
    _0: Array<string>,
    _1: 'increasePrio' | 'decreasePrio' | 'topPrio' | 'bottomPrio',
  ): Promise<void> {
    return this.generateResponse();
  }

  async addTorrentTag(_0: Array<string>, _1: Array<string>): Promise<void> {
    return this.generateResponse();
  }

  async removeTorrentTag(_0: Array<string>, _1?: Array<string>): Promise<void> {
    return this.generateResponse();
  }

  async createTag(_: Array<string>): Promise<void> {
    return this.generateResponse();
  }

  async deleteTags(_: Array<string>): Promise<void> {
    return this.generateResponse();
  }
  ...
  async deleteCategory(_: Array<string>): Promise<void> {
    return this.generateResponse();
  }
  ...
  async setCategory(_0: Array<string>, _1: string): Promise<void> {
    return this.generateResponse();
  }
  ...
  async banPeers(_: Array<string>): Promise<void> {
    return this.generateResponse();
  }
